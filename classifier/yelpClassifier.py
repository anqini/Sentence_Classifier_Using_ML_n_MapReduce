...
class YelpClassifier(object):
    ...
    def calculate_likelihoods(self, train_rdd):
        ...
        class_likelihoods = train_rdd.flatMap(self.review_to_word_counts) \
    ...
    def review_to_word_counts(self, review):
        ...
        review_id,  num_stars, review_text_as_string = review
        words = review_text_as_string.split(' ')
        return [((num_stars, word), 1) for word in words]
        
    
    def add_review_counts(self, count1, count2):
    ...
    def counts_to_probabilities(self, num_stars_and_word_counts):
        ...
        dict = {}
        stars_and_word, num_reviews_with_word_and_stars = num_stars_and_word_counts
        num_stars, word_in_review = stars_and_word
        dict[word_in_review] = self.compute_likelihood(num_reviews_with_word_and_stars, num_stars)
        return (num_stars, dict)
    ...
    def review_to_num_stars_num_words(self, review):
    ...
    def add_review_and_word_counts(self, count1, count2):
    ...
    def review_to_num_stars_and_word_pairs(self, review):
    ...
    def add_log_likelihoods(self, likelihood1, likelihood2):
    ...
    def review_id_only_as_key(self, stars_id_posterior):
    ...
    def find_max_posterior(self, num_stars_posterior1, num_stars_posterior2):
        ...
        num_stars1, log_posterior1 = num_stars_posterior1
        num_stars2, log_posterior2 = num_stars_posterior2
